...
def send_course_update_email(course_id: int):
    ...
    # Пример аккуратного переноса строк в материалах (PEP 8)
    subject = "Обновление материалов курса"
    message = f"Курс {course.title} был успешно обновлен! Зайдите на платформу, чтобы посмотреть новые уроки."
